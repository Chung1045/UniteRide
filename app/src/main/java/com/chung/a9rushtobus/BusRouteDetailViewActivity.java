    ...
    public void loadBusRouteStopData() {
        ...
        try {
            ...
            if (Objects.equals(busCompany, "kmb")) {
                ...
                cursor.close();
            } else if (busCompany.equals("ctb")) {
                String query = "SELECT DISTINCT rs." + CTBDatabase.Tables.CTB_ROUTE_STOPS.COLUMN_STOP_SEQ + ", " +
                        "rs." + CTBDatabase.Tables.CTB_ROUTE_STOPS.COLUMN_STOP_ID + ", " +
                        "s." + CTBDatabase.Tables.CTB_STOPS.COLUMN_NAME_EN + ", " +
                        "s." + CTBDatabase.Tables.CTB_STOPS.COLUMN_NAME_TC + ", " +
                        "s." + CTBDatabase.Tables.CTB_STOPS.COLUMN_NAME_SC + ", " +
                        "s." + CTBDatabase.Tables.CTB_STOPS.COLUMN_LATITUDE + ", " +
                        "s." + CTBDatabase.Tables.CTB_STOPS.COLUMN_LONGITUDE +
                        " FROM " + CTBDatabase.Tables.CTB_ROUTE_STOPS.TABLE_NAME +
                        " rs" + " JOIN " + CTBDatabase.Tables.CTB_STOPS.TABLE_NAME + " s" +
                        " ON rs." + CTBDatabase.Tables.CTB_ROUTE_STOPS.COLUMN_STOP_ID +
                        " = s." + CTBDatabase.Tables.CTB_STOPS.COLUMN_STOP_ID +
                        " WHERE rs." + CTBDatabase.Tables.CTB_ROUTE_STOPS.COLUMN_ROUTE + " =?" +
                        " AND rs." + CTBDatabase.Tables.CTB_ROUTE_STOPS.COLUMN_BOUND + " =?";
                ...
                String[] selectionArgs = {routeNumber, routeBound};
                Log.d("BusRouteDetailView", "Query Args: " + Arrays.toString(selectionArgs));
                Log.d("BusRouteDetailView", "Query: " + query);
                ...
                if (cursor.moveToFirst()) {
                    do {
                        // Extract data from cursor
                        String stopId = cursor.getString(cursor.getColumnIndexOrThrow(CTBDatabase.Tables.CTB_ROUTE_STOPS.COLUMN_STOP_ID));
                        String stopNameEn = cursor.getString(cursor.getColumnIndexOrThrow(CTBDatabase.Tables.CTB_STOPS.COLUMN_NAME_EN));
                        String stopNameTc = cursor.getString(cursor.getColumnIndexOrThrow(CTBDatabase.Tables.CTB_STOPS.COLUMN_NAME_TC));
                        String stopNameSc = cursor.getString(cursor.getColumnIndexOrThrow(CTBDatabase.Tables.CTB_STOPS.COLUMN_NAME_SC));
                        String latitude = cursor.getString(cursor.getColumnIndexOrThrow(CTBDatabase.Tables.CTB_STOPS.COLUMN_LATITUDE));
                        String longitude = cursor.getString(cursor.getColumnIndexOrThrow(CTBDatabase.Tables.CTB_STOPS.COLUMN_LONGITUDE));
